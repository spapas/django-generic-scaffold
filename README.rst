...
As can be seen from tox.ini, the tests are run for Python 2.7 and Django 1.6-1.11 and for Python 3.6 and Django 1.8-2.0, so these would be the supported versions.
